  ...
  const integrations = [
    {
      ...
      icon: (
        <svg className="w-4 h-4 text-[#0052CC]" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12.002 2L6 8.002l6.002 6.002L18.004 8.002 12.002 2zm-5.002 5L1 13l6.002 6.002L13.004 13 7 7zm10.004 0L11 13l6.002 6.002L23.004 13l-6.002-6z" opacity="0.85"/>
        </svg>
      ),
    },
    {
